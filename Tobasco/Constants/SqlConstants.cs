namespace Tobasco.Constants
{
	public class SqlConstants
	{
		...
		public const string DeclareChildIdLists = "DeclareChildIdLists";
		public const string Childs_GetByIds = "Childs_GetByIds";
		public const string ChildCollection_GetByIds = "ChildCollection_GetByIds";
	}
}